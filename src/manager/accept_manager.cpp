...
AcceptManager::AcceptManager(HANDLE iocp_handle, SOCKET listen_socket, LPFN_ACCEPTEX fnAcceptEx)
    : iocp_handle_(iocp_handle), listen_socket_(listen_socket), fnAcceptEx_(fnAcceptEx) {}
...
void AcceptManager::handle_accept(DWORD bytes_transferred, LPOVERLAPPED overlapped) {
